...
namespace Xylia.Preview.Project.Core.ItemGrowth.Page
{
	partial class IntensionResetConfirmPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.CurrentOptionList = new Xylia.Preview.Project.Core.ItemGrowth.Game_Intension.Preview.OptionList();
			this.AcquirableOptionList = new Xylia.Preview.Project.Core.ItemGrowth.Game_Intension.Preview.OptionList();
			...
			this.Load += new System.EventHandler(this.IntensionResetConfirmPanel_Load);
		...
		private Game_Intension.Preview.OptionList CurrentOptionList;
		private Game_Intension.Preview.OptionList AcquirableOptionList;
