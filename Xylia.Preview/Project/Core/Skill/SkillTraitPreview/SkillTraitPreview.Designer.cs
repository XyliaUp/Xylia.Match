namespace Xylia.Preview.Project.Core.Skill
{
    partial class SkillTraitPreview
	{
        ...
        {
			this.traitTier1 = new Xylia.Preview.Project.Core.Skill.TraitTier();
			this.ucBtnExt1 = new HZH_Controls.Controls.UCBtnExt();
			this.TooltipEffectDescription = new Xylia.Preview.Project.Controls.ContentPanel();
			this.TooltipTrainDescription = new Xylia.Preview.Project.Controls.ContentPanel();
			this.TooltipTrainName = new Xylia.Preview.Project.Controls.ContentPanel();
			...
			this.traitTier1.Size = new System.Drawing.Size(626, 72);
			...
			this.Select_Job.TextAlign = System.Windows.Forms.HorizontalAlignment.Left;
			...
			this.Select_JobStyle.TextAlign = System.Windows.Forms.HorizontalAlignment.Left;
