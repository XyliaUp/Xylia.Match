namespace Xylia.Preview.Project.Core.Item
{
	partial class SetItemPreview
	{
		...
		private void InitializeComponent()
		{
			...
			this.itemShowCell2 = new Xylia.Preview.Project.Core.Item.Cell.Basic.ItemShowCell();
			this.GemPreview = new Xylia.Preview.Project.Core.Item.GemPreview();
		...
		private Xylia.Preview.Project.Core.Item.Cell.Basic.ItemShowCell itemShowCell2;
