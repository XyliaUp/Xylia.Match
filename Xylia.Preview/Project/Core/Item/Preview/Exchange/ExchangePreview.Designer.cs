namespace Xylia.Preview.Project.Core.Item
{
	partial class ExchangePreview
	{
		...
		private void InitializeComponent()
		{
			...
			this.ProcessComparisonCell = new Xylia.Preview.Project.Core.Item.Cell.ProcessComparisonCell();
			this.ProcessMaterial = new Xylia.Preview.Project.Core.Item.Cell.Basic.ItemShowCell();
			this.Process = new Xylia.Preview.Project.Core.Item.Cell.Basic.ItemShowCell();
			this.SuspendLayout();
			// 
			// ProcessTitle
			// 
		...
		private Xylia.Preview.Project.Core.Item.Cell.Basic.ItemShowCell Process;
		private Xylia.Preview.Project.Core.Item.Cell.Basic.ItemShowCell ProcessMaterial;
